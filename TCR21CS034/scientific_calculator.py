...
tk_calc = Tk()
tk_calc.configure(bg="#0f172a", bd=15)
tk_calc.title("Scientific Calculator")

calc_operator = ""
text_input = StringVar()

text_display = Entry(tk_calc, font=('Times', 18, 'bold'), textvariable=text_input,
                     bd=5, insertwidth = 5, bg='#fff', justify='right').grid(columnspan=5, padx = 10, pady = 15)

button_params = {'bd':5, 'fg':'#4f4e61', 'bg':'#c0f0e2', 'font':('Times', 18, 'bold')}
button_params_main = {'bd':5, 'fg':'#000', 'bg':'#00ffb3', 'font':('Times', 18, 'bold')}
...
# Powers of 10
tens_powers = Button(tk_calc, button_params, text='10^x', font=('Times', 15, 'bold'),
...
log_base10 = Button(tk_calc, button_params, text='log\u2081\u2080', font=('Times', 16, 'bold'),
...
delete_one = Button(tk_calc, bd=5, fg='#000', font=('Times', 18, 'bold'),
              text='DEL', command=button_delete, bg='#00d9ff').grid(row=6, column=3, sticky="nsew")
delete_all = Button(tk_calc, bd=5, fg='#000', font=('Times', 18, 'bold'),
              text='AC', command=button_clear_all, bg='#00d9ff').grid(row=6, column=4, sticky="nsew")
...
exp = Button(tk_calc, button_params_main, text='EXP', font=('Times', 16, 'bold'),
